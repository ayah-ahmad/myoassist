...
def _analyze_process(log_dir):
    ...
    orig_load = stable_baselines3.PPO.load
    def cpu_only_load(*args, **kwargs):
        kwargs["device"] = "cpu"
        return orig_load(*args, **kwargs)
    stable_baselines3.PPO.load = cpu_only_load
...
class BaseCustomLearningCallback(BaseCallback):
    ...
    def _init_callback(self):
        ...
        self.pool = ctx.Pool(processes=self.n_eval_workers)
